...
public class FirmGenerationVisitor implements AstVisitor {
    ...
    final Mode modeSizeT = Mode.getLu(); // for calloc
    final Mode modeBool = Mode.getBu(); //TODO unsigned byte?
    ...
    public FirmGenerationVisitor() {
        ...
        MethodType calloc_type = new MethodType(new firm.Type[]{new PrimitiveType(modeSizeT),new PrimitiveType(modeSizeT)}, new firm.Type[]{new PrimitiveType(reference)});
