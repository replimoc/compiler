...
public final class RegisterAllocationPolicy {
	...
	public static final RegisterAllocationPolicy A_B_C_D_8_9_10_11_12_BP_DI_SI = new RegisterAllocationPolicy(new SingleRegister[][] {
			// 64bit registers
	...
	public static final RegisterAllocationPolicy A_BP_B_12__DI_SI_D_C_8_9_10_11 = new RegisterAllocationPolicy(new SingleRegister[][] {
			// 64bit registers
			{ SingleRegister.RAX, SingleRegister.RBP, SingleRegister.RBX, SingleRegister.R12,
			...
			// 32 bit registers
			{ SingleRegister.EAX, SingleRegister.EBP, SingleRegister.EBX, SingleRegister.R12D,
			...
			// 8 bit registers
			{ SingleRegister.AL, SingleRegister.BPL, SingleRegister.BL, SingleRegister.R12B,
