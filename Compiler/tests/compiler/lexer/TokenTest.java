...
public class TokenTest {
	...
	public void testToString() {
		...
		assertEquals("line   2, character  4: integer literal 2342342", new Token(TokenType.INTEGER, new Position(2, 4), "2342342").toString());
	...
	public void testgetTokenString() {
		...
		assertEquals("integer literal 2342342", new Token(TokenType.INTEGER, null, "2342342").getTokenString());
